...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://eventiq-final-project.onrender.com/api/v1/login', {
  ...
  const resendVerificationCode = async (email) => {
    try {
      await axios.post('https://eventiq-final-project.onrender.com/api/v1/resendOtp', { email })
      ...
      <section className='signup-container-Login'>
        ...
        <div className='left-section3'>
          ...
          <div className='left-content3'>
            ...
            <p>Manage your event halls with ease and get more bookings, all on Eventiq.</p>
          </div>
        </div>
            ...
            >
              ...
              <div className='input-group-Login_password password-field-Login'>
                <label>
                  <Lock
                    size={14}
                    className='label-icon-Login_password'
                  />{' '}
                  Password
                </label>
